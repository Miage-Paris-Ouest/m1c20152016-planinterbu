...
<html>
    ...
    <body>
     <table class="ruban"> 
        ...
        <font face="Verdana" size="6"> <p align="center"> <b >  Selectionnez la discipline de l'ouvrage désiré :  </b > </p>   </font>

        <FORM method="post" action="Recherche">
  <div align="center"> 
 <table  border='1px'  classe="tableau"> 
 <tr> <td width="150px"height="50px" cellpadding="0"  >
<SELECT  name="sdiscipline" size="1" >
...
<% ResultSet rs = bean.getRs();
    while (rs.next()) {
    String nom = rs.getString("discipline");
