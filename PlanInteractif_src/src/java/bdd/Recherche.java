...
public class Recherche extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
          ...
          PrintWriter out = response.getWriter();
           ...
           out.println( "<h1>Résultats de votre recherche </h1>" );
        ...
        String rslt="";
        rslt=livre3.rechercheparcote(rechercheCote);
         out.println(rslt);
         ...
         if ((rechercheDiscipline ) != null)
                 {
                  String dis=" ";
         String rslt="";
         rslt=livre1.RechercheParDiscipline(rechercheDiscipline);
         out.println(rslt);
         ...
         String ssdis=" ";
         String rslt="";
        rslt=livre2.RechercheParSsDiscipline(rechercheSousDiscipline);
         out.println(rslt);
        ssdis= livre2.affichSsDiscipline(rechercheSousDiscipline, ssdis);
