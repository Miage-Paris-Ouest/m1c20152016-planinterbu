...
public void rechercheparcote(String coteSaisie)
{
...
System.out.println("Salle :"+salle+ "/nNuméro etagère :"+etagerenontraite+"/nDiscipline  "+discipline+"/nSous discipline"+ssdiscipline+"/nCote saisie : "+cote+" ");
...
public void RechercheParDiscipline(String disc)
{
        try {
Class.forName("oracle.jdbc.driver.OracleDriver");
}
     ...
     
{
   ...
   String ssdiscipline = rs.getString("ssdiscipline");
   String etagerenontraite = rs.getString("etagere");
System.out.println(salle+ " "+etagerenontraite+" "+discipline+" "+ssdiscipline+" "+cote+" ");
...
public void RechercheParSsDiscipline(String ssDisc)
